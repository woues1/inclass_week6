...
public class LibraryApp {
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println("=== Library Management System - Sample Data Insertion ===\n");
            ...
            System.out.println("\nCreating borrowed book records...");
            ...
            System.out.println("\nBorrowed books by Alice Johnson:");
            ...
            System.out.println("\n=== Testing Criteria API Queries ===");

            System.out.println("\nBooks containing 'Pride' in title:");
            List<Book> prideBooks = libraryDAO.findBooksByCriteria("Pride");
            for (Book b : prideBooks) {
                System.out.println("- " + b.getTitle());
            }

            System.out.println("\nStudents with email 'alice.johnson@university.edu':");
            ...
            System.out.println("\n=== Library System Demo Completed Successfully! ===");
